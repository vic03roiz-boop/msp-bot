...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const message = await interaction.channel.send({ embeds: [buildLobbyEmbed(wheel)], components: [row] });
    wheel.messageId = message.id;
    await message.react(JOIN_EMOJI);
    await interaction.editReply({ content: '✅ Roue de la fortune publiée !' });
